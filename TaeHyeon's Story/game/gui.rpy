...
define gui.accent_color = '#ff00dd'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#fc62e8'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#ffe6ff'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#ff00dd'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#fa7fea'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#f833ff'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#fc62e8'
define gui.hover_muted_color = '#fc62e8'

## The colors used for dialogue and menu choice text.
define gui.text_color = '#ff00dd'
define gui.interface_text_color = '#fc62e8'


## Fonts and Font Sizes ########################################################

## The font used for in-game text.
define gui.text_font = "font/BMJUA.ttf"

## The font used for character names.
define gui.name_text_font = "font/BMJUA.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "font/BMJUA.ttf"
...
define gui.main_menu_background = "bg/GreatDay2.png"
...
define gui.choice_button_text_idle_color = "#ffcce6"
define gui.choice_button_text_hover_color = "#ff99ce"
