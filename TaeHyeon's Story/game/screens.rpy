...
style window:
    ...
    background Image("gui/textbox_pink.png", xalign=0.5, yalign=1.0)
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            # textbutton _("Q.로드") action QuickLoad()
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("게임시작") action Start()
        ...
        if renpy.variant("pc"):
            ...
            textbutton _("조작키") action ShowMenu("help")
...
style main_menu_frame:
    ...
    background "gui/overlay/main_menu_pink.png"
...
screen help():
    ...
    use game_menu(_("  조작키"), scroll="viewport"):
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("대화를 진전시키고 인터페이스를 활성화한다.")

    hbox:
        label _("Space")
        text _("선택을 하지 않고 대화를 진전시킨다.")
    ...
    hbox:
        label "V"
        text _("토글 보조 장치 - {a=https://www.renpy.org/l/voicing}셀프 보이스틱{/a}.")
