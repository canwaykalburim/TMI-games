init -1 python hide:
    ...
    style.default.font = "font/BMJUA.ttf"
    ...
    u'jEdit requires Java be installed on your computer.'
    : u'jEdit를 실행하려면 Java가 설치되어야 합니다.',

    u'Disables the automatic launching of an editor.'
    : u'자동으로 편집기를 실행하지 않습니다.'
