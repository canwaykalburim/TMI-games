...
define gui.accent_color = '#ff00fe'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#ffc5ff'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#ff00fe'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#ff00fe'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#ffeafd'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#ffc0f8'
...
define gui.text_color = '#ffc0f8'
define gui.interface_text_color = '#ffc0f8'
...
define gui.main_menu_background = "gui/main_menu_seontae.png"
